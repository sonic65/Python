...
import sys   
sys.path.append('/Users/sonic/Project/Python/Demo/bilibili/testcase/')
sys.path.append('/Users/sonic/Project/Python/Demo/bilibili/package/')
...
if __name__ == '__main__':
    ...
    suit.addTest(Lonin_Page("test_login"))
