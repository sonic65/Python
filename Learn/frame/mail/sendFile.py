...
username_send = 'sonicxp3000@163.com'  #邮箱用户名
password = '56749154@163'   #邮箱密码：需要使用授权码
username_recv = '56749154@qq.com'  #收件人，多个收件人用逗号隔开
mail = MIMEMultipart()
# file = r'E:\\testpy\\python-mpp\\day8\\练习\\sendmail.py'
# att = MIMEText(open(file,encoding='utf-8').read())  #这个只可以发送py或者txt附件，复杂一点的就会报错
file=r'E:\Work\Project\Python\DEMO\mail\sendFile.py'
